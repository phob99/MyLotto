...
Public Class frm_Main
    ...
    Private Sub Ts_EnterData_Click(sender As Object, e As EventArgs) Handles ts_EnterData.Click


        CallForm(frm_EnterData)

        'Dim ChildForm As New frm_EnterData
        '' Make it a child of this MDI form before showing it.
    ...
    End Sub
    Private Sub CallForm(frmCall As Form)


        Dim objForms As Form
        For Each objForms In Me.MdiChildren
            If objForms.Name = frmCall.Name Then
